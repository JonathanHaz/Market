  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 mt-24">
        <div className="max-w-3xl mx-auto text-2xl sm:text-5xl lg:6xl font-semibold text-center">
          ...
          <p className="lg:text-lg text-muted-foreground mx-auto mt-5 w-[90%] font-normal text-base">AniKet is the best place to find the best Anime merch for your next adventure</p>
        </div>
